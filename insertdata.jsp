...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			...
			 			String query1="select * from user  where username='"+uname+"' and grp='"+grp+"'"; 
					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="userlogin.jsp">Click here to Login</a>  <br /><br />       <a href="index.html">Home</a> </p>
					   ...
					   {
							PreparedStatement ps=connection.prepareStatement("insert into user(grp,username,password,email,mobile,dob,gender,address,pincode,status,image) values(?,?,?,?,?,?,?,?,?,?,?)");
						ps.setString(1,grp);
