...
<%		
    ...
    try{
		...
		if(type.equalsIgnoreCase("user"))
		{
			...
			application.setAttribute("grp",grp);
			
			String sql="SELECT * FROM user where username='"+username+"' and password='"+Password+"' and grp='"+grp+"' and status='authorized'";
			...
			{
			String sql1="SELECT * FROM user where username='"+username+"' and password='"+Password+"' and grp='"+grp+"' and status='waiting'";
